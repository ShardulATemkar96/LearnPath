        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearningPaths_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classrooms_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Classrooms_LearningPaths_LearningPathId",
                        column: x => x.LearningPathId,
                        principalTable: "LearningPaths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_LearningPaths_LearningPathId",
                        column: x => x.LearningPathId,
                        principalTable: "LearningPaths",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleDependencies", x => new { x.ModuleId, x.DependsOnModuleId });
                    table.ForeignKey(
                        name: "FK_ModuleDependencies_Modules_DependsOnModuleId",
                        column: x => x.DependsOnModuleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_UserId_LearningPathId",
                table: "Certificates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classrooms_LearningPathId",
                table: "Classrooms",
                column: "LearningPathId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningPaths_CreatedById",
                table: "LearningPaths",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_ModuleDependencies_DependsOnModuleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Progresses_UserId_ModuleId",
                table: "Progresses",
